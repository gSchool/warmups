...
function sortByLetter(first, second) {
	return first.letter.toLowerCase().localeCompare(second.letter.toLowerCase());
}
...
function sortByLetterCapsFirst(first, second) {
	var firstIsCap = first.letter.toUpperCase() === first.letter;
	var secondIsCap = second.letter.toUpperCase() === second.letter;

	if(firstIsCap && secondIsCap) {
